...
def run(params):
    ...
    cues = P['cues']
    print(perceived, cues)
    if drug_type == 'biophysical':
    ...
    # df_primary.to_csv('df_primary.csv')
    # df_firing.to_csv('df_firing.csv')
...
def main():
    ...
    # primary_dataframe.to_csv('primary_df.csv')
    # firing_dataframe.to_csv('firing_df.csv')
    ...
    figure2, (ax3, ax4) = plt.subplots(1, 2, figsize=(12, 12))
    ...
    ax3.set(xlabel='time (s)', xlim=(0.0, 9.5), ylim=(0, 250), ylabel='Normalized Firing Rate',
